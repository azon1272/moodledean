...
$string['forstudent'] = 'Учащимся';
$string['forteacher'] = 'Преподавателям';
$string['formanager'] = 'Администрации';
$string['link_name_ages'] = 'Учебные периоды';
$string['link_name_agroups'] = 'Академические группы';
$string['link_name_cpassed'] = 'Изучаемые и пройденные дисциплины';
$string['link_name_cstreams'] = 'Учебные процессы';
...
$string['link_name_programmitems'] = 'Дисциплины';
...
$string['learning_process'] = 'Учебный процесс';
...
$string['process_organizing'] = 'Организация учебного процесса';
$string['participants_cstreams'] = 'Учебный план учащихся';
$string['import_cstreams'] = 'Импорт учебных процессов';
$string['teacher_load'] = 'Нагрузка преподавателей';
...
$string['link_name_metaprogrammitems'] = 'Метадисциплины';
$string['order_change_teacher'] = 'Приказ на передачу нагрузки преподавателя';
